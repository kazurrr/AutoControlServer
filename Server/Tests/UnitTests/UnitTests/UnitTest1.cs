...
namespace UnitTests
{
    ...
    public class UnitTest1
    {
        ...
        public String getAllCarsFromDatabase()
        {
            ...
            string url = "http://localhost:9946/api/cars/getall";
        ...
        public void addCar()
        {
            var httpWebRequest = (HttpWebRequest)WebRequest.Create("http://localhost:9946/api/cars/post");
        ...
        public void deleteCarFromDatabase()
        {
            ...
            string url = "http://localhost:9946/Home/DeleteCar/";
